...
class scene1 extends Phaser.Scene {
    ...
    create() {
        ...
        this.scoreText = this.add.text(58, 3, "0", {fontSize: "30px", fill: "#ffffff"})

        // Hearts
        this.heartsGroup = this.physics.add.group({})
        this.physics.add.collider(this.heartsGroup, this.groundGroup)
        this.physics.add.overlap(this.dude, this.heartsGroup, this.collectHearts, null, this)

        this.add.image(16, 16, "heart")
/*         this.scoreText = this.add.text(116, 3, "0", {fontSize: "35px", fill: "#ffffff"}) */
    ...
    addGround() {
        ...
        if(Phaser.Math.Between(0, 1)) {
            ...
            this.heartsGroup.create(Phaser.Math.Between(0, game.config.width), 0, "heart")
            this.heartsGroup.setVelocityY(gameOptions.dudeSpeed)
    ...
    update() {
        ...
        if(this.cursors.up.isDown && this.dude.body.touching.down) {
            this.dude.body.velocity.y = -gameOptions.dudeGravity / 1.4
        }
